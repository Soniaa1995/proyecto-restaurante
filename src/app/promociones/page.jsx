  ...
  return (
    <div className="p-5">
      ...
      <section className="mb-4 p-6">
        <h3 className="text-center font-semibold text-xl mb-4 sm:text-2xl lg:text-3xl">
      ...
      <section className="mb-5 p-6">
        <h3 className="text-center font-semibold text-xl mb-4 sm:text-2xl md:text-4xl">
          La Tennessee
        </h3>
